...
def index():
    ...
    'Reviews' : 'sum',
    'Rating'  : 'mean'}).sort_values(by=['Reviews'], ascending=False).iloc[0:10].reset_index().to_html(classes=['table thead-light table-striped table-bordered table-hover table-sm'])
    }
